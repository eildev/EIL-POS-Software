				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
							...
							<input type="text" name="name" value="{{$customer->name}}" class="form-control field_required" placeholder="Enter Customer name">
						</div>
					</div><!-- Col -->
					<div class="col-sm-6">
						<div class="mb-3 form-valid-groups">
							<label class="form-label">Phone<span class="text-danger">*</span></label>
							<input type="text" name="phone" value="{{$customer->phone}}" class="form-control" placeholder="Enter Customer Phone">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="mb-3">
