                        ...
                        <div class="row">
                                    ...
                                    @if ($products->count() > 0)
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}"
                                                {{ $damage_info->product_id == $product->id ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-valid-groups">
                                    ...
                                    <input type="text" value="{{ $damage_info->qty }}" id="damageQty" name="pc"
                                        onkeyup="damage_qty(this);" class="form-control" placeholder="0" disabled
