                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="forms">
                        <ul class="nav sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('product.info.report') }}" class="nav-link">Product Info Report</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('summary.report') }}" class="nav-link">Summary Report</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('customer.due.report') }}" class="nav-link">Customer Due Report</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('supplier.due.report') }}" class="nav-link">Supplier Due Report</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('customer.ledger.report') }}" class="nav-link">Customer Ledger</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('suppliers.ledger.report') }}" class="nav-link">Supplier Ledger</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('account.transaction.view') }}" class="nav-link">Expense Report</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('employee.salary.report.view') }}" class="nav-link">Employee Salary
                                    Report</a>
                            </li>
                            <li class="nav-item">
