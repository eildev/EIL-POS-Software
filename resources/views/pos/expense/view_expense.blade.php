                    ...
                    <div class="modal-body">
                        <form id="signupForm" class="categoryFormEdit">
                            <div class="mb-3">
                                ...
                                <input id="defaultconfig" class="form-control edit_category_name" maxlength="250"
                                                ...
                                                @foreach ($expense as $key => $expenses)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('expense.delete', $expenses->id) }}"
                                        ...
                                        <tbody class="showData">
                                            ...
                                            @foreach ($expenseCat as $key => $expenseCategory)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" data-id={{ $expenseCategory->id }}
                                                            data-bs-toggle="modal" data-bs-target="#edit"
                                                            class="btn btn-sm btn-primary btn-icon category_edit">
                                                            <i data-feather="edit"></i>
                                                        </a>
                                                        <a href="{{ route('expense.category.delete', $expenseCategory->id) }}"
                                                            id="delete" class="btn btn-sm btn-danger btn-icon ">
                                                            <i data-feather="trash-2"></i>
                                                        </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3 w-100">
                                            ...
                                            <select
                                                class="expense_category_name is-valid js-example-basic-single form-control filter-category @error('expense_category_id') is-invalid @enderror"
                                                name="expense_category_id" aria-invalid="false" width="100">
